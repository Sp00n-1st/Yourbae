...
import 'package:yourbae_project/model/rating_model.dart';
...
class FirebaseController extends GetxController {
  ...
  Query<WishlistModel> queryWishlist2() {
    return firebase.collection('wishlist').withConverter<WishlistModel>(
        fromFirestore: (snapshot, _) => WishlistModel.fromJson(snapshot.data()),
        toFirestore: (wishlist, _) => wishlist.toJson());
  }
